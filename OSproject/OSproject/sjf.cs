...
namespace OSproject
{
    ...
    public class sjf
    {
        ...
        public static string nonpreemptive(process[] p, int n, Form1 x)
        {
            ...
            a= "Average waiting time equals " + average_waiting_time + "\n" + "Average turnaround time equals " + average_turnaaround_time;
            return a;
        }


        public static float preemptive(process[] p, int n, Form1 x)
        {
            // process[] touchable = new process[n];
            int count = 0;
            int end = 0;
